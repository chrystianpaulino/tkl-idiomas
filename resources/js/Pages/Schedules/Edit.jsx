...
export default function SchedulesEdit({ schedule, classes }) {
    ...
    return (
        <AppLayout title="Editar Regra de Agenda">
            <Head title="Editar Regra de Agenda" />

            <PageHeader title="Editar Regra de Agenda" subtitle="Atualize quando esta turma terá aulas recorrentes">
                <Link
                    href="/schedules"
            ...
            <form onSubmit={submit} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 max-w-3xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="md:col-span-2">
                        <label htmlFor="class_id" className="block text-sm font-medium text-gray-700 mb-1.5">Turma</label>
                        <select
                            id="class_id"
                            value={data.class_id}
